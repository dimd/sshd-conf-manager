...
class RedisSubscriberTest(unittest.TestCase):
    ...
    def test_listen(self, gevent_mock):
        ...
        self.redis_subscriber.redis_logger.error.assert_called_with('error')
    ...
    def test_start_connection_error(self, gevent_mock):
        ...
        self.redis_subscriber.redis_logger.error.assert_called_with(
                'error Will retry in 5 seconds.')
